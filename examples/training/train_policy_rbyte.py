...
def _train_smolvla_rbyte(hydra_cfg: DictConfig) -> None:
    ...
    input_features = {
        ...
        OBS_STATE: PolicyFeature(
            ...
            shape=dataset_stats[OBS_STATE]["mean"].shape,
        ),
        OBS_STATE_VEHICLE: PolicyFeature(
            type=FeatureType.STATE,
            shape=dataset_stats[OBS_STATE_VEHICLE]["mean"].shape,
        ),
    }
    ...
    output_features = {
        ACTION: PolicyFeature(
            ...
            shape=dataset_stats[ACTION]["mean"].shape,
        )
    }
