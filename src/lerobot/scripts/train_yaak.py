...
def train(
    ...
    dataloader_eval: torch.utils.data.DataLoader | None = None,
    ...
    num_frames_eval = len(dataloader_eval.dataset.samples) if dataloader_eval else num_frames
    ...
    for _ in range(step, cfg.steps):
        ...
        if is_log_step:
            ...
            if wandb_logger:
                ...
                if output_dict:
                    # Do not overwrite the running averages from the tracker
                    wandb_log_dict.update({
                        (k if k not in wandb_log_dict else f"{k}_raw"): v
        ...
        if is_eval_step:
            if is_main_process:
                ...
                if wandb_logger:
                    ...
                    wandb_logger.log_dict({**wandb_log_dict, **eval_info}, step, mode="eval")
